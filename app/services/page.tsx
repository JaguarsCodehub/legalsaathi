  ...
  const services = [
    {
      ...
      desc: "Comprehensive sale agreement documentation for real estate transactions. Get legally binding contracts drafted and registered with expert legal guidance for property sales. We ensure all terms and conditions are clearly defined and protect both buyer and seller interests.",
    ...
    },
    {
      ...
      desc: "Professional rent agreement services with complete legal documentation. We handle leave and license agreements for residential and commercial properties with doorstep service. Our agreements are compliant with all state regulations and protect both landlord and tenant rights.",
    ...
    },
    {
      ...
      desc: "Authorized property registration services approved by Government of Maharashtra. We ensure smooth registration process for all your real estate documents. Our team handles all paperwork, verification, and ensures timely completion of registration.",
    ...
    },
    {
      ...
      desc: "Expert legal document drafting services for all your real estate needs. From contracts to agreements, we provide comprehensive legal documentation support. Our legal experts ensure all documents are accurate, compliant, and protect your interests.",
    ...
    },
    {
      ...
      desc: "Thorough property verification and due diligence services. We help verify property titles, ownership, and legal status before you make any real estate investment. Our comprehensive verification process ensures you make informed decisions.",
      image: "https://images.pexels.com/photos/7578935/pexels-photo-7578935.jpeg?auto=compress&cs=tinysrgb&w=800",
      icon: "🔍",
      features: ["Title verification", "Ownership check", "Legal status", "Due diligence"],
    },
    {
      title: "Remote Legal Services",
      desc: "Complete legal documentation services for property owners residing outside Maharashtra or India. Get biometric verification and document processing done remotely. We make it possible to complete your property documentation from anywhere in the world.",
      image: "https://images.pexels.com/photos/7688336/pexels-photo-7688336.jpeg?auto=compress&cs=tinysrgb&w=800",
      icon: "🌐",
      features: ["Remote biometric", "Online processing", "Global service", "Doorstep assistance"],
    },
  ];
